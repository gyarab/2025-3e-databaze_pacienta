...
const dict: Record<Lang, Record<string, string>> = {
  ...
  help: "Nápověda",
  howToTitle: "Jak používat MediCare",
  howToIntro: "Krátký průvodce, který vám pomůže rychle začít a používat aplikaci efektivně.",
  howToStep1: "Přidejte záznam: klikněte na 'Přidat záznam' a vyplňte typ, datum a popis.",
  howToStep2: "Připojte dokumenty: v dialogu přidejte PDF nebo obrázek jako přílohu. Po uložení si je můžete otevřít nebo stáhnout.",
  howToStep3: "Filtrovat a vyhledávat: klikněte na karty nahoře (Léky / Dokumenty / Operace) pro rychlé filtrování časové osy.",
  lang: "cs",
  open: "Otevřít",
  download: "Stáhnout",
  close: "Zavřít",
  ...
  help: "Help",
  howToTitle: "How to use MediCare",
  howToIntro: "A short, eye-catching step-by-step guide to get you started and manage your health records.",
  howToStep1: "Add a record: click 'Add record' and fill type, date and description.",
  howToStep2: "Attach files: add PDFs or images in the dialog. After saving you can open or download them.",
  howToStep3: "Filter & find: click the top cards (Medications / Documents / Surgeries) to quickly filter the timeline.",
  lang: "en",
  open: "Open",
  download: "Download",
  close: "Close",
